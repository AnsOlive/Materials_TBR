...
Be = openmc.Material(name = 'Natural Beryllium')
Be.add_element('Be' , 1)
Be.add_s_alpha_beta('c_Be')
Be.set_density('g/cm3' , 1.848)

Materials = openmc.Materials([FLiBe, Be])
